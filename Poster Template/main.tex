...
\usepackage{epstopdf} % Adds .eps file functionality
\usepackage{todonotes} % Adds todonote functionality
\usepackage{mwe} % Necessary for title logo inclusion
...
{\begin{tikzpicture}[remember picture, overlay] % Adds logo space depending on anchor choice
     \node [anchor=north east, inner sep=3.5cm]  at (current page.north east)
     {\begin{tabular}{ccc}
     \includegraphics[height=4cm]{logo.png} & \hfill & \includegraphics[height=4cm]{logo.png}
     \end{tabular}};
     \end{tikzpicture}}
